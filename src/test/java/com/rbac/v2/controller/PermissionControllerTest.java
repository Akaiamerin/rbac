...
class PermissionControllerTest {
    ...
    @Test
    public void testInsertPermissionList() throws Exception {
    ...
    @Test
    public void testUpdatePermissionById() throws Exception {
        Integer id = 1;
        Map<String, Object> map = new HashMap<>(Map.ofEntries(
                Map.entry("name", "a"),
    ...
    @Test
    public void testUpdatePermissionByIdList() throws Exception {
        ...
        String responseString = mockMvc
                .perform(
                        MockMvcRequestBuilders
                                .put("/api/permission/batch/{idList}", string)
                                .contentType(MediaType.APPLICATION_JSON)
                                .content(jsonString)
                )
                .andReturn()
    ...
    @Test
    public void testUpdatePermissionList() throws Exception {
        List<Map<String, Object>> list = new ArrayList<>(Arrays.asList(
                new HashMap<>(Map.ofEntries(
                        Map.entry("id", 1),
                        Map.entry("name", "a1"),
    ...
    @Test
    public void testSelectPermissionById() throws Exception {
        Integer id = 1;
        String responseString = mockMvc
                .perform(
                        MockMvcRequestBuilders
    ...
    @Test
    public void testSelectPermissionByIdList() throws Exception {
        String string = Stream
                .of(1, 2, 3)
                .map((Integer id)->{
                    return String.valueOf(id);
        ...
        String responseString = mockMvc
                .perform(
                        MockMvcRequestBuilders
                                .get("/api/permission/batch/{idList}", string)
                )
                .andReturn()
                .getResponse()
                .getContentAsString();
    ...
    @Test
    public void testSelectPermissionByPagination() throws Exception {
